 ...
 */
export function isDependencyVersionCompatible(path, dependency, version) {
    try {
 ...
 */
export function checkExperimentalDecorators(backendPath) {
    ...
    if (tsconfig?.compilerOptions?.experimentalDecorators === true) {
        throw new UserError(`The experimentalDecorators option is enabled in your ${tsconfigPath} file. Please disable it to use genezio decorators.`);
    }
}
