export class GenezioCloudFormationBuilder {
    ...
    addDefaultResourcesForBackendDeployment(apiGatewayResourceName, apiGatewayName) {
...
export function getLambdaPermissionResource(lambdaFunctionResourceName, apiGatewayResourceName) {
    return {
...
export function getApiGatewayRouteResource(apiGatewayResourceName, routeKey, integration) {
    return {
...
export function getApiGatewayIntegrationResource(apiGatewayResourceName, lambdaFunctionResourceName) {
    return {
...
export function getLambdaFunctionResource(name, runtime, roleResourceName, bucketName, bucketKey, latestObjectVersion) {
    return {
...
export function getEventsRoleResource(scheduleExpression, lambdaFunctionResourceName, targetId, input) {
    return {
...
export function getLambdaPermissionForEventsResource(lambdaFunctionResourceName, cronResourceName) {
    return {
        Type: "AWS::Lambda::Permission",
        Properties: {
            Action: "lambda:InvokeFunction",
...
export function getS3BucketResource(websiteConfiguration = undefined, accessControl = undefined, publicAccessBlockConfig = undefined) {
    const bucket = {
        Type: "AWS::S3::Bucket",
        Properties: {
...
export function getS3BucketPublicResource(bucketName) {
    return {
...
export function getCloudFrontDistributionResource(bucketName, bucketResourceName) {
    return {
