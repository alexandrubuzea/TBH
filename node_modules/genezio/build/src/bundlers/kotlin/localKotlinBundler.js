...
var _KotlinBundler_instances, _KotlinBundler_castParameterToPropertyType, _KotlinBundler_getProperCast, _KotlinBundler_createRouterFileForClass, _KotlinBundler_compile;
// Libs
...
_KotlinBundler_instances = new WeakSet(), _KotlinBundler_castParameterToPropertyType = function _KotlinBundler_castParameterToPropertyType(node, variableName) {
    let implementation = "";
    switch (node.type) {
...
}, _KotlinBundler_compile = async function _KotlinBundler_compile(folderPath) {
