...
export default async function getProjectInfoByName(projectName, region) {
    const authToken = await getAuthToken();
    if (!authToken) {
        throw new UserError("You are not logged in. Run 'genezio login' before you deploy your function.");
    }
...
export async function getProjectEnvFromProjectByName(projectName, region, stageName) {
