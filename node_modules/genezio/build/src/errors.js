...
export const GENEZIO_NO_CLASSES_FOUND = (_language) => {
    ...
    let errorMessage = "You don't have any class specified in the genezio.yaml configuration file.";
    if (decoratorSyntax) {
...
export const GENEZIO_NOT_ENOUGH_PERMISSION_FOR_FILE = function (filePath) {
...
export const GENEZIO_DECORATOR_YAML_OVERLAP = function (overlappingClasses) {
...
function collectIssueMap(e, issueMap) {
...
export function zodFormatError(e) {
    let errorString = "";
