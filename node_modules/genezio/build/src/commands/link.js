...
import { deleteLinkPathForProject, deleteAllLinkPaths, setLinkPathForProject, } from "../utils/linkDatabase.js";
...
async function getProjectName() {
    const projectConfiguration = await yamlConfigIOController.read().catch((_error) => {
        throw new UserError("Command execution failed. Please ensure you are running this command from a directory containing 'genezio.yaml' or provide the [projectName] argument.");
    });
    return projectConfiguration.name;
}
export async function linkCommand(projectName) {
