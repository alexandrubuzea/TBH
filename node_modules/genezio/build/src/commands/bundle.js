...
import { CloudAdapterIdentifier, CloudProviderIdentifier, } from "../models/cloudProviderIdentifier.js";
export async function bundleCommand(options) {
    ...
    const sdkResponse = await sdkGeneratorApiHandler(backendConfiguration.language.name, mapYamlClassToSdkClassConfiguration(backendConfiguration.classes, backendConfiguration.language.name, backendConfiguration.path), backendConfiguration.path, 
