...
let FRONTEND_DOMAIN;
let PORT_LOCAL_ENVIRONMENT;
let LOCAL_TEST_INTERFACE_URL;
let DART_COMPILATION_ENDPOINT;
let ENABLE_DEBUG_LOGS_BY_DEFAULT;
let ENVIRONMENT;
let SENTRY_DSN;
let GENEZIO_REGISTRY;
let REQUIRED_GENEZIO_TYPES_VERSION_RANGE;
let RECOMMENTDED_GENEZIO_TYPES_VERSION_RANGE;
...
const NODE_MINIMUM_VERSION = "18.2.0";
if (environment === "dev") {
...
export { DASHBOARD_URL, FRONTEND_DOMAIN, BACKEND_ENDPOINT, PORT_LOCAL_ENVIRONMENT, ENABLE_DEBUG_LOGS_BY_DEFAULT, LOCAL_TEST_INTERFACE_URL, DART_COMPILATION_ENDPOINT, GENEZIO_TELEMETRY_ENDPOINT, ENVIRONMENT, SENTRY_DSN, GENEZIO_REGISTRY, REQUIRED_GENEZIO_TYPES_VERSION_RANGE, RECOMMENTDED_GENEZIO_TYPES_VERSION_RANGE, NODE_MINIMUM_VERSION, AMPLITUDE_API_KEY, GA_MEASUREMENT_ID, GA_API_SECRET, };
